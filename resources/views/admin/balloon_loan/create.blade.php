        ...
        <form method="POST" action="{{route('admin.balloonstore')}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="slidecontainer">
                    <input type="range" min="1" max="20" value="1" name="balloon_terms" class="slider" id="ballon_start_date">
                    <div class="term">
            ...
            <div class="form-group">
                <label class="start_date" for="start_date">{{ trans('Start date') }}</label>
                <input class="form-control date" type="text" name="start_date" id="start_date" placeholder="00/00/0000" required>
